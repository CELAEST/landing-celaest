...
// =====================================================================
// CELAEST · Particle UI Brain
// Réplica fiel de la escena Spline (dos emisores + force collider).
//  - Capa A: emisor interior (denso, mayormente azul) → estructura
//  - Capa B: emisor de superficie (blend azul/naranja, más drift) → flujo
//  - Force Follow: esfera de repulsión que sigue al cursor en 3D
// =====================================================================
...
// Shaders compartidos por ambas capas (sólo cambian uniforms)
...
// NOTE: removed `useGLTF.preload(...)` — it eagerly fetched 1 MB at page-load
// even when the user never scrolled to the Products section. The Canvas now
// downloads the GLTF lazily, gated by the IntersectionObserver above.