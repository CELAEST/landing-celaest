...
export function PricingSection() {
  ...
  return (
    <section ref={ref} id="pricing" className="py-24 bg-brand-deep relative overflow-hidden">
      {/* Background accents */}
      ...
      <div className="relative section-container">
        ...
        <div className={cn('text-center mb-16 scroll-reveal', isVisible && 'is-visible')}>
          ...
          <p className="text-xl text-brand-soft max-w-2xl mx-auto">{t('subtitle')}</p>
        </div>
              ...
              >
                ...
                <div className="text-center mb-8 pt-4">
                  ...
                  <div className="flex items-baseline justify-center gap-2">
                    {price === 'Custom' ? (
                      <span className="text-5xl font-bold text-brand-ice">{price}</span>
                    ) : (
                      <>
                    ...
                    <li key={feature} className="flex items-start gap-3">
                      <Check
                        className={cn(
                          ...
                          plan.popular ? 'text-brand-mint' : 'text-brand-slate-light'
                        )}
                      />
